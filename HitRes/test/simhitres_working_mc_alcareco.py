...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'file:025D803E-7534-E611-9D0E-0025905B85DC_QCD_Pt_30to50_TuneCUETP8M1_13TeV_pythia8_RunIISpring16DR80-TkAlMinBias-PUSpring16_ALCATkAlMinBias_80X_mcRun2_asymptotic_2016_v3-v1_ALCARECO.root'
        ),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('HitRes_MC_alcareco.root')
)
...
process.MeasurementTrackerEvent.stripClusterProducer = cms.string('ALCARECOTkAlMinBias')
process.MeasurementTrackerEvent.pixelClusterProducer = cms.string('ALCARECOTkAlMinBias')
